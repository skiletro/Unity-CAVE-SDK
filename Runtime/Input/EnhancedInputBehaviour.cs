...
using System.Collections.Generic;
    ...
    /// Provides adjustment variables to hone to your CAVE setup.
    /// </summary>
namespace MMUCAVE
{
    public class EnhancedInputBehaviour : MonoBehaviour
    {
        ...
        [Header("Threshold Adjustments")] [Tooltip("The maximum inputs your display can handle")]
        [SerializeField] private static int maxInputCount = 10;
        [Tooltip("The minimum distance a touch must move to register as a swipe")] [SerializeField] private float minimumDistance = 100f;
        ...
        void DetectSwipe(Finger finger)
        {
            ...
            if (Vector2.Distance(_lastPositions[finger.index], finger.currentTouch.screenPosition) >= minimumDistance)
            {
                ...
                SwipeDirection(_directions[finger.index]); //in this example it rotates the view
            }
            else{
